...
export default class SpaceTraderShipMissingMountsError extends SpaceTraderApiError {
    constructor(spaceTraderErrorDto: SpaceTraderErrorDto) {
        super(spaceTraderErrorDto, "api.spacetraders.ship.ship-missing-mounts-error");
    }
}