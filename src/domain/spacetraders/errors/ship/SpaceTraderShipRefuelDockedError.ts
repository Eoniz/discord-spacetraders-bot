...
export default class SpaceTraderShipRefuelDockedError extends SpaceTraderApiError {
    constructor(spaceTraderErrorDto: SpaceTraderErrorDto) {
        super(spaceTraderErrorDto, "api.spacetraders.ship.ship-refuel-docked-error");
    }
}