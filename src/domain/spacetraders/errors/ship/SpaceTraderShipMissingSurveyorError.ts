...
export default class SpaceTraderShipMissingSurveyorError extends SpaceTraderApiError {
    constructor(spaceTraderErrorDto: SpaceTraderErrorDto) {
        super(spaceTraderErrorDto, "api.spacetraders.ship.ship-missing-surveyor-error");
    }
}